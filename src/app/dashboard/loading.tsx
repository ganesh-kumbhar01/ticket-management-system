    ...
    <div className="p-4 md:p-6 min-h-full animate-pulse">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="mb-6">
          ...
          <div className="h-4 w-96 bg-slate-100 dark:bg-slate-800 dark:bg-slate-800 rounded-lg"></div>
        </div>
              ...
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex items-center gap-4">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="h-3 w-2/3 bg-slate-100 dark:bg-slate-800 dark:bg-slate-800 rounded"></div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="space-y-2">
                  <div className="h-4 w-full bg-slate-200 rounded"></div>
                  <div className="h-10 w-full bg-slate-100 dark:bg-slate-800 dark:bg-slate-800 rounded"></div>
                </div>
              ))}
            </div>
          </div>
